...
describe('Content Script Observers - Advanced Tests', () => {
  ...
  describe('MutationObserver Scenarios', () => {
    ...
    test('handles mutations that remove marked elements', () => {
      ...
      const finalBadges = document.querySelectorAll('.fool-badge').length;
    ...
    test('handles observer disconnection and reconnection', () => {
      ...
      expect(observedMutations.length).toBeGreaterThanOrEqual(countAfterDisconnect);
    ...
    test('handles mutations in nested iframes', () => {
      // Create iframe
      document.body.innerHTML = '<iframe id="testframe"></iframe><div id="main"><span>AAPL</span></div>';
    ...
    test('periodic check does not duplicate badges', () => {
      ...
      symbolToNodes1.forEach((textNodes, symbol) => {
        textNodes.forEach(textNode => {
          ...
          if (!parent || renderer.isMarked(parent)) return;
      ...
      const badgeCount1 = document.querySelectorAll('.fool-badge').length;
      ...
      const badgeCount2 = document.querySelectorAll('.fool-badge').length;
  ...
  describe('Message Listener Scenarios', () => {
    ...
    test('reload while badges are being created', () => {
      ...
      expect(document.querySelectorAll('.fool-badge').length).toBeGreaterThanOrEqual(0);
    });
